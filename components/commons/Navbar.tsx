      ...
      <div className="max-w-[1280px] mx-auto h-full flex items-center justify-between px-6 gap-3">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <div className="relative">
            <button onClick={() => setLoginOpen(!loginOpen)} className="flex items-center gap-1.5 no-underline text-white text-[13px] font-semibold px-4 py-1.5 border-2 border-white/25 rounded-full hover:bg-white/10 hover:border-white/40 transition-all">
              Login
