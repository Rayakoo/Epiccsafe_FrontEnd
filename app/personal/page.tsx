...
export default function PersonalPage() {
  return (
    <div className="min-h-screen bg-[#1A0A0A] text-white">
      {/* Navbar */}
      <nav className="sticky top-0 z-100 bg-[#5C0000] border-b border-white/10 flex items-center justify-between px-5 gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <a href="/login" className="flex items-center gap-1.5 no-underline text-white text-[13px] font-semibold px-3.5 py-1.5 border-2 border-white/50 rounded-full hover:bg-white/15 transition-colors">
            Login
          ...
          <div className="flex items-center gap-0.5 border-2 border-white/40 rounded-full px-2 py-1 text-[12.5px] font-semibold">
      ...
      <main className="max-w-[1100px] mx-auto px-6 py-12 flex flex-col gap-10">
        ...
        <div className="flex items-center gap-4 animate-fadeUp">
          ...
          <h1 className="text-3xl font-bold text-white">Laporkan Insiden <span className="text-[#E8001D]">Phishing & Fraud</span></h1>
        </div>
        ...
        <div className="grid grid-cols-[280px_1fr] gap-7 items-start">
          ...
          <div className="flex flex-col gap-4">
            {/* Peringatan Aktif */}
            <div className="bg-[#2A1212] border border-[rgba(232,0,29,0.4)] rounded-xl p-5 relative overflow-hidden animate-fadeUp [animation-delay:0.1s]">
              <div className="absolute inset-0 bg-gradient-to-br from-white/4 to-transparent pointer-events-none"></div>
              <h3 className="text-[14px] font-bold text-[#E8001D] mb-2.5 flex items-center gap-2">
            ...
            {/* Laporan Aman */}
            <div className="bg-[#0E2B1A] border border-[rgba(26,107,60,0.5)] rounded-xl p-5 relative overflow-hidden animate-fadeUp [animation-delay:0.2s]">
              <div className="absolute inset-0 bg-gradient-to-br from-white/4 to-transparent pointer-events-none"></div>
              <h3 className="text-[14px] font-bold text-[#3FB870] mb-2.5 flex items-center gap-2">
            ...
            {/* Proses Penanganan */}
            <div className="bg-[#2A1212] border border-[rgba(232,0,29,0.3)] rounded-xl p-5 relative overflow-hidden animate-fadeUp [animation-delay:0.3s]">
              <div className="absolute inset-0 bg-gradient-to-br from-white/4 to-transparent pointer-events-none"></div>
              <h3 className="text-[14px] font-bold text-[#E8001D] mb-3.5 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-[#E8001D] shadow-[0_0_6px_#E8001D]"></span>
                Proses Penanganan
              </h3>
              <ul className="list-none flex flex-col gap-1.5 text-[12.5px] text-white/75">
                <li className="flex items-start gap-2.5"><span className="font-mono text-[11px] font-medium text-[#E8001D] bg-[rgba(232,0,29,0.1)] border border-[rgba(232,0,29,0.25)] rounded px-1.5 py-0.5 flex-shrink-0 mt-0.5">1</span> Submitted — Laporan diterima sistem</li>
                <li className="flex items-start gap-2.5"><span className="font-mono text-[11px] font-medium text-[#E8001D] bg-[rgba(232,0,29,0.1)] border border-[rgba(232,0,29,0.25)] rounded px-1.5 py-0.5 flex-shrink-0 mt-0.5">2</span> Triage — Kategorisasi & prioritas</li>
                <li className="flex items-start gap-2.5"><span className="font-mono text-[11px] font-medium text-[#E8001D] bg-[rgba(232,0,29,0.1)] border border-[rgba(232,0,29,0.25)] rounded px-1.5 py-0.5 flex-shrink-0 mt-0.5">3</span> Verifikasi — Investigasi oleh tim</li>
                <li className="flex items-start gap-2.5"><span className="font-mono text-[11px] font-medium text-[#E8001D] bg-[rgba(232,0,29,0.1)] border border-[rgba(232,0,29,0.25)] rounded px-1.5 py-0.5 flex-shrink-0 mt-0.5">4</span> Mitigasi — Blokir & tindak lanjut</li>
                <li className="flex items-start gap-2.5"><span className="font-mono text-[11px] font-medium text-[#E8001D] bg-[rgba(232,0,29,0.1)] border border-[rgba(232,0,29,0.25)] rounded px-1.5 py-0.5 flex-shrink-0 mt-0.5">5</span> Close — Kasus selesai</li>
              </ul>
            </div>
          </div>

          {/* Right Column - Form Card */}
          <div className="bg-[#2C2C2C] border-none rounded-2xl overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.4)] animate-fadeUp [animation-delay:0.15s]">
            <div className="bg-[#5C0000] px-7 py-5.5">
              <div className="font-mono text-lg font-semibold tracking-[2px] text-white">EPICCSAFE</div>
              <p className="text-[13px] text-white/70 mt-1">Form Pelaporan Phishing & Fraud — CIMB Niaga</p>
            </div>
            <form className="p-7 flex flex-col gap-4.5">
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Nama Pelapor</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Email Pelapor</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Link URL Yang Dilaporkan</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Tindakan / Perbuatan yang Dilaporkan</label>
                <div className="flex gap-2.5 flex-wrap">
                  <button type="button" className="flex-1 flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-lg border-2 border-white/10 bg-[#4A4A4A] text-[#ECECEC] font-sans text-[14px] font-semibold cursor-pointer hover:border-[rgba(232,0,29,0.5)] transition-all active:border-[#E8001D] active:bg-[rgba(232,0,29,0.12)] active:text-white">
                    <span className="w-3 h-3 rounded-full bg-white/25 border-2 border-white/30"></span>
                    SMS
                  </button>
                  <button type="button" className="flex-1 flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-lg border-2 border-white/10 bg-[#4A4A4A] text-[#ECECEC] font-sans text-[14px] font-semibold cursor-pointer hover:border-[rgba(232,0,29,0.5)] transition-all">
                    <span className="w-3 h-3 rounded-full bg-white/25 border-2 border-white/30"></span>
                    WhatsApp
                  </button>
                  <button type="button" className="flex-1 flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-lg border-2 border-white/10 bg-[#4A4A4A] text-[#ECECEC] font-sans text-[14px] font-semibold cursor-pointer hover:border-[rgba(232,0,29,0.5)] transition-all">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Ringkasan Kejadian</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-semibold text-[#ECECEC]">Upload Bukti (Opsional)</label>
                <div className="border-2 border-dashed border-white/15 rounded-xl bg-[#4A4A4A] p-10 text-center cursor-pointer hover:border-[#E8001D] hover:bg-[rgba(232,0,29,0.05)] transition-all flex flex-col items-center gap-2.5">
                  <div className="text-[#9A9A9A] text-2xl">⬆</div>
                  <div className="text-[13px] text-[#9A9A9A]">Klik untuk upload atau drag & drop</div>
                  <div className="text-[12px] text-[#9A9A9A] font-mono">PNG, JPG, PDF — Maks. 5MB per file</div>
                </div>
              </div>

              <div className="flex justify-end mt-6 pt-0 border-t-0">
                <button type="submit" className="bg-[#E8001D] text-white border-none rounded-lg px-10 py-3 font-sans text-[15px] font-bold tracking-[0.3px] cursor-pointer hover:bg-[#FF001F] hover:shadow-[0_4px_20px_rgba(232,0,29,0.45)] hover:-translate-y-0.5 transition-all active:translate-y-0">
                  Submit
                </button>
              </div>
            </form>
