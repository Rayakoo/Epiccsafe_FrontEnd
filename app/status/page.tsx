    ...
    <div className="min-h-screen bg-[#140606] text-white">
      ...
      <main className="max-w-[980px] mx-auto px-4 md:px-6 py-8 md:py-11">
          ...
          <div className="bg-white/6 border border-white/10 rounded-2xl overflow-hidden order-1 md:order-2">
            ...
            <div className="bg-[#2c2c2c] p-5 md:p-6 flex flex-col gap-3 md:gap-3.5">
              ...
              <input
                ...
                spellCheck="false"
              />
              <button className="w-full bg-[#e03030] text-white font-sans text-[14px] md:text-[15px] font-bold rounded-lg p-3 md:p-3.5 cursor-pointer hover:bg-[#ff4444] hover:-translate-y-0.5 transition-all active:translate-y-0">
                Lacak Laporan
              </button>
            </div>
          </div>
        ...
        <div id="resultSection" className="rounded-2xl overflow-hidden">
          <div className="bg-[#3a0808] px-5 md:px-8 py-4 md:py-6 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 border-b border-white/6">
            <span id="resultTitle" className="text-[16px] md:text-[18px] font-extrabold text-white leading-relaxed">Website phishing mirip CIMB Niaga</span>
            <div id="resultRisk" className="bg-white/15 text-white text-[13px] md:text-[15px] font-extrabold px-4 md:px-5.5 py-2 md:py-2.5 rounded-lg whitespace-nowrap flex-shrink-0 border border-white/20 w-fit">
              Risk : 0
            </div>
          </div>
          ...
          <div className="bg-[#2a2a2a] min-h-[300px]">
            <div className="p-6 md:p-9 flex flex-col gap-5 md:gap-7 relative">
              ...
              <div className="flex items-start gap-4 md:gap-5 relative">
                ...
                <div className="pt-2.5 pb-6 md:pb-8">
                  <p className="text-[15px] md:text-[16px] font-bold text-white mb-1">Submitted</p>
                  <p className="text-[12.5px] md:text-[13.5px] text-white/70 leading-relaxed">Laporan diterima sistem</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 md:gap-5 relative">
                ...
                <div className="w-11 h-11 rounded-full bg-white/12 border-2 border-white/25 flex items-center justify-center flex-shrink-0 relative z-10">
                  <svg width="20" viewBox="0 0 24 24" fill="none" stroke="white/70" strokeWidth="2">
                    <circle cx="12" cy="12" r="10"/>
                    <path d="M12 6v6l4 2"/>
                  </svg>
                </div>
                <div className="pt-2.5 pb-6 md:pb-8">
                  <p className="text-[15px] md:text-[16px] font-bold text-white/70 mb-1">In Review</p>
                  <p className="text-[12.5px] md:text-[13.5px] text-white/50 leading-relaxed">Sedang dianalisis tim keamanan</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 md:gap-5">
                ...
                <div className="pt-2.5">
                  <p className="text-[15px] md:text-[16px] font-bold text-white/70 mb-1">Confirmed</p>
                  <p className="text-[12.5px] md:text-[13.5px] text-white/50 leading-relaxed">Menunggu verifikasi</p>
                </div>
              </div>
            </div>

            {/* SLA Footer */}
            <div className="bg-white/3 border-t border-white/7 px-5 md:px-8 py-3 md:py-4 flex items-center justify-between">
              <span className="text-[13px] md:text-[14px] text-white/70 font-medium">SLA Target</span>
              <span className="text-[14px] md:text-[15px] font-extrabold text-[#e03030]">2 jam</span>
            </div>
          </div>
        </div>
      </main>
