export default function DashboardPage() {
  return (
    <div className="flex-1 flex flex-col">
      {/* Topbar */}
      <header className="h-14 bg-[#162030] border-b border-white/10 sticky top-0 z-40 flex items-center justify-between px-7">
        <h1 className="text-[17px] font-bold text-[#E8EDF2]">Dashboard</h1>
      ...
      <main className="flex-1 p-6 flex flex-col gap-4.5">
        {/* Alert Banner */}
        <div className="flex items-center gap-3 bg-[rgba(139,0,0,0.4)] border border-[rgba(232,0,29,0.4)] rounded-xl p-3.5 text-[13.5px] text-[#E8EDF2]">
        ...
        {/* Section Header */}
        <div>
          <h2 className="text-xl font-extrabold text-[#E8EDF2]">Dashboard Analytics</h2>
          <p className="text-[12px] text-[#6B7E93] mt-0.5">Data per Maret 2026</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3.5">
          {/* Bar Chart */}
          <div className="bg-[#1B2A3B] border border-white/10 rounded-xl p-5">
            <p className="text-[13px] font-bold mb-4.5 text-[#E8EDF2]">Tren 7 hari</p>
          ...
          {/* Pie Chart */}
          <div className="bg-[#1B2A3B] border border-white/10 rounded-xl p-5">
            <p className="text-[13px] font-bold mb-4.5 text-[#E8EDF2]">Top Modus</p>
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col gap-2.5 text-[12.5px] text-[#E8EDF2]">
        ...
        <div className="grid grid-cols-2 gap-3.5">
          {/* Resolution Time */}
          <div className="bg-[#1B2A3B] border border-white/10 rounded-xl p-5">
            <p className="text-[13px] font-bold mb-4 text-[#E8EDF2]">Rata-rata Waktu Penyelesaian</p>
            ...
            <div className="flex justify-between items-center pt-2.5 border-t border-white/10 text-[12px]">
              <span className="text-[#6B7E93]">Rata-rata keseluruhan</span>
              <span className="font-mono font-bold text-[#2196F3] text-[13px]">1.6j</span>
            </div>
            <div className="mt-2 text-[12px] text-[#6B7E93] bg-white/5 rounded-lg p-2">
          ...
          {/* Victim Segmentation */}
          <div className="bg-[#1B2A3B] border border-white/10 rounded-xl p-5">
            <p className="text-[13px] font-bold mb-4 text-[#E8EDF2]">Segmentasi Korban</p>
            ...
            <p className="text-[12px] text-[#6B7E93] pt-2.5 border-t border-white/10">
        ...
        <div className="bg-[#1B2A3B] border border-white/10 rounded-xl overflow-hidden">
          <div className="flex items-center justify-between p-4.5 border-b border-white/10">
            <h3 className="text-[15px] font-bold text-[#E8EDF2]">Tiket Terbaru</h3>
            <div className="flex gap-2.5">
              <button className="px-4 py-1.5 rounded-lg border border-white/20 bg-transparent text-[#E8EDF2] text-[12.5px] font-semibold hover:bg-white/5 transition-colors">
                Lihat Semua
              </button>
              <button className="px-4 py-1.5 rounded-lg bg-[#E8001D] text-white text-[12.5px] font-bold hover:bg-[#ff1a32] transition-colors">
                Triage Sekarang
              </button>
            </div>
          </div>
