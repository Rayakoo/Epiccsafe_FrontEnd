    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 p-4 md:p-8 flex flex-col gap-4 md:gap-5">
        ...
        <div>
          ...
          <p className="text-[11px] md:text-[12.5px] text-[#6B7E93] mt-0.5">5 total · semua tiket</p>
        </div>
        ...
        <div className="bg-[#1B2A3B] border border-white/10 rounded-xl md:rounded-2xl overflow-hidden">
          <div className="p-4 md:p-5 border-b border-white/10 text-[15px] md:text-[16px] font-extrabold text-[#E8EDF2]">Semua Tiket</div>
