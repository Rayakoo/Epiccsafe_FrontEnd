  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <header className="h-14 bg-[#162030] border-b border-white/10 sticky top-0 z-40 flex items-center justify-between px-8">
        <h1 className="text-[17px] font-bold text-[#E8EDF2]">Triage</h1>
      ...
      <main className="flex-1 p-8 flex flex-col gap-5">
        {/* Page Header */}
        <div>
          <h2 className="text-2xl font-extrabold text-[#E8EDF2]">Triage</h2>
          <p className="text-[12.5px] text-[#6B7E93] mt-0.5" id="pageSub">3 tiket menunggu</p>
        </div>
