      ...
      <main className="flex-1 p-4 md:p-7 flex flex-col gap-4 md:gap-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-4 md:gap-5 items-start">
          ...
          <div className="flex flex-col gap-4 order-2 lg:order-1">
            ...
            {/* Keputusan Triage */}
            <div className="bg-[#1B2A3B] border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-5.5">
              <h3 className="text-[15px] md:text-[16px] font-extrabold text-[#E8EDF2] mb-3 md:mb-4">Keputusan Triage</h3>
              <div className="flex flex-col sm:flex-row gap-3">
                <button className="px-5 md:px-7 py-3 rounded-lg bg-[#1A6B3C] text-white text-[13px] md:text-[14px] font-bold hover:bg-[#1F7D47] hover:-translate-y-0.5 transition-all" onClick={() => window.location.href = '/admin/mitigasi'}>
                  Confirm Phising
                </button>
                <button className="px-5 md:px-7 py-3 rounded-lg bg-[#6B0000] text-white text-[13px] md:text-[14px] font-bold hover:bg-[#8B0000] hover:-translate-y-0.5 transition-all">
                  False Positive
                </button>
              </div>
            </div>
